...
class AES {
    ...
    public static void trace_static() {
        ...
        for (n = 0; n < 16; ++n) {
            for (n2 = 0; n2 < 16; ++n2) {
                System.out.print(Util.toHEX1(S[n * 16 + n2]) + ", ");
            }
            System.out.println();
        }
        System.out.print("Si[] = \n");
        for (n = 0; n < 16; ++n) {
            for (n2 = 0; n2 < 16; ++n2) {
                System.out.print(Util.toHEX1(Si[n * 16 + n2]) + ", ");
            }
            System.out.println();
        }
        ...
        for (n = 0; n < 5; ++n) {
            for (n2 = 0; n2 < 6; ++n2) {
                System.out.print(Util.toHEX1(rcon[n * 6 + n2]) + ", ");
            }
            System.out.println();
        }
        ...
        for (n = 0; n < 32; ++n) {
            for (n2 = 0; n2 < 8; ++n2) {
                System.out.print(Util.toHEX1(log[n * 8 + n2]) + ", ");
            }
            System.out.println();
        }
        ...
        for (n = 0; n < 32; ++n) {
            for (n2 = 0; n2 < 8; ++n2) {
                System.out.print(Util.toHEX1(alog[n * 8 + n2]) + ", ");
            }
            System.out.println();
        }
    }
    ...
    public byte[] encrypt(byte[] arrby) {
        ...
        if (this.traceLevel > 0) {
            this.traceInfo = "encryptAES(" + Util.toHEX1(arrby) + ")";
        }
        if (arrby == null) {
        ...
        if (this.traceLevel > 2) {
            this.traceInfo = this.traceInfo + "\n  R0 (Key = " + Util.toHEX1(arrby4) + ")\n\tAK = " + Util.toHEX1(arrby2);
        } else if (this.traceLevel > 1) {
            this.traceInfo = this.traceInfo + "\n  R0 (Key = " + Util.toHEX1(arrby4) + ")\t = " + Util.toHEX1(arrby2);
        }
        for (int i = 1; i < this.numRounds; ++i) {
            arrby4 = this.Ke[i];
            if (this.traceLevel > 1) {
                this.traceInfo = this.traceInfo + "\n  R" + i + " (Key = " + Util.toHEX1(arrby4) + ")\t";
            }
            for (n3 = 0; n3 < 16; ++n3) {
                arrby3[n3] = S[arrby2[n3] & 255];
            }
            if (this.traceLevel > 2) {
                this.traceInfo = this.traceInfo + "\n\tSB = " + Util.toHEX1(arrby3);
            }
            for (n3 = 0; n3 < 16; ++n3) {
                n2 = n3 % 4;
            ...
            this.traceInfo = this.traceInfo + " = " + Util.toHEX1(arrby2);
        }
        arrby4 = this.Ke[this.numRounds];
        if (this.traceLevel > 1) {
            this.traceInfo = this.traceInfo + "\n  R" + this.numRounds + " (Key = " + Util.toHEX1(arrby4) + ")\t";
        }
        for (n3 = 0; n3 < 16; ++n3) {
            arrby2[n3] = S[arrby2[n3] & 255];
        }
        if (this.traceLevel > 2) {
            this.traceInfo = this.traceInfo + "\n\tSB = " + Util.toHEX1(arrby2);
        }
        for (n3 = 0; n3 < 16; ++n3) {
            n2 = n3 % 4;
            n = (n3 + row_shift[n2] * 4) % 16;
    ...
    public byte[] decrypt(byte[] arrby) {
        ...
        this.traceInfo = "";
        if (this.traceLevel > 0) {
            this.traceInfo = "decryptAES(" + Util.toHEX1(arrby) + ")";
        }
        if (arrby == null) {
        ...
        for (int i = 1; i < this.numRounds; ++i) {
            ...
            if (this.traceLevel > 2) {
                this.traceInfo = this.traceInfo + "\n\tISR = " + Util.toHEX1(arrby3);
            }
            for (n3 = 0; n3 < 16; ++n3) {
                arrby2[n3] = Si[arrby3[n3] & 255];
            }
            if (this.traceLevel > 2) {
                this.traceInfo = this.traceInfo + "\n\tISB = " + Util.toHEX1(arrby2);
            }
            for (n3 = 0; n3 < 16; ++n3) {
                arrby3[n3] = (byte)(arrby2[n3] ^ arrby4[n3]);
            }
            if (this.traceLevel > 2) {
                this.traceInfo = this.traceInfo + "\n\t AK = " + Util.toHEX1(arrby3);
            }
            for (int j = 0; j < 4; ++j) {
                n3 = j * 4;
    ...
    public void setKey(byte[] arrby) {
        ...
        this.traceInfo = "";
        if (this.traceLevel > 0) {
            this.traceInfo = "setKey(" + Util.toHEX1(arrby) + ")\n";
        }
        if (arrby == null) {
        ...
        if (this.traceLevel > 3) {
            ...
            for (n2 = 0; n2 < this.numRounds + 1; ++n2) {
                this.traceInfo = this.traceInfo + "  R" + n2 + "\t = " + Util.toHEX1(this.Ke[n2]) + "\n";
            }
            this.traceInfo = this.traceInfo + "  Decrypt Round keys:\n";
            for (n2 = 0; n2 < this.numRounds + 1; ++n2) {
                this.traceInfo = this.traceInfo + "  R" + n2 + "\t = " + Util.toHEX1(this.Kd[n2]) + "\n";
            }
        }
    }

    public static void self_test(String string, String string2, String string3, int n) {
        byte[] arrby = Util.hex2byte(string);
        byte[] arrby2 = Util.hex2byte(string2);
        byte[] arrby3 = Util.hex2byte(string3);
        AES aES = new AES();
        aES.traceLevel = n;
        aES.setKey(arrby);
        ...
        if (Arrays.equals(arrby4, arrby3)) {
            ...
            System.out.print("Test Failed. Result was " + Util.toHEX(arrby4) + "\n");
        }
    ...
    public static void main(String[] arrstring) {
        ...
        switch (arrstring.length) {
            ...
            case 3: {
                AES.self_test(arrstring[0], arrstring[1], arrstring[2], n);
                System.exit(0);
                break;
            }
            case 4: {
        ...
        AES.self_test("000102030405060708090a0b0c0d0e0f", "00112233445566778899aabbccddeeff", "69c4e0d86a7b0430d8cdb78070b4c55a", n);
        AES.self_test("000102030405060708090a0b0c0d0e0f1011121314151617", "00112233445566778899aabbccddeeff", "dda97ca4864cdfe06eaf70a0ec0d7191", n);
        AES.self_test("000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f", "00112233445566778899aabbccddeeff", "8ea2b7ca516745bfeafc49904b496089", n);
    }
