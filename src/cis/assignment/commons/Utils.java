...
package cis.assignment.commons;
...
public class Utils {
    ...
    public static byte[] hex2byte(String string) {
        ...
        int n3 = 0;
        if (n % 2 == 1) {
            arrby[n3++] = (byte)Utils.hexDigit(string.charAt(n2++));
        }
        while (n2 < n) {
            arrby[n3++] = (byte)(Utils.hexDigit(string.charAt(n2++)) << 4 | Utils.hexDigit(string.charAt(n2++)));
        }
        return arrby;
    }
